...
const plugins = () => {
	return src(`${srcFolder}/plugins/**/*`)
		.pipe(dest('./app/plugins'))
}
...
const tinypng = () => {
	if (typeof env != "undefined") {
		...
		console.log('\x1b[33m', 'Tiny can\'t work without key parameter, check the env variables or set key explicitly in function')
	}
...
exports.build = series(clean, parallel(htmlInclude, scriptsBuild, fonts, resources, plugins, imgToApp, svgSprites), stylesBuild, tinypng)
